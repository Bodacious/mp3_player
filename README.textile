...
*To install:* <tt>script/plugin install git://github.com/GavinM/mp3_player.git</tt>

*To setup:* <tt>rake mp3_player</tt>
...
Copyright (c) 2009 "Gavin Morrice":http://gavinmorrice.com, released under the MIT license
